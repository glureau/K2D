...
Current version: <!--$ GRADLE_PROPERTIES version -->0.4.5<!-- END $-->
...
With a simple setup, you can generate a classes diagram for an entire package, and produce similar diagrams in your documentation.
...
This plugin generates markdown file so you can use it with Dokka (as screenshots above) or any other documentation tool supporting mermaid diagrams.
